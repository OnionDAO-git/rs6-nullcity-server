...
> Null City humans (operators, demo hosts, new contributors): start with [HUMANS.md](HUMANS.md). New developers: start with [docs/new-developer-onboarding.md](docs/new-developer-onboarding.md). AI agents: start with [AGENTS.md](AGENTS.md). This README preserves the upstream RuneJS server notes.
>
