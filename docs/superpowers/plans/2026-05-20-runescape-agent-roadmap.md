...
- `[>]` **S1: AP ledger and resident life-force proof.**
  ...
  - 2026-05-29 (`agents/wip`, codex): packet `S1b` added benchmark substrate (`ap-decay-ask-5m` task + low-attention benchmark soul override) with focused tests, but live autonomous artifact capture is blocked in this sandbox (`controller:bench` loopback connect EPERM to `127.0.0.1:43595`). See `docs/capability-evidence/2026-05-29-s1b-ap-life-force-benchmark-attempt.md`.
