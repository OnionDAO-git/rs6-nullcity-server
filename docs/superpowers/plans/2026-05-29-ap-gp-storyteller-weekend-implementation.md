...
| CQA4 | In Review | codex | 2026-05-30 | src/controller/admin/named-trade-soak.ts; src/controller/admin/named-trade-soak.test.ts; src/controller/city-integration/http-server.ts; src/controller/city-integration/http-server.test.ts; src/controller/city-integration/ap-gp-exchange.ts; src/controller/city-integration/ap-gp-exchange.test.ts; docs/capability-evidence/2026-05-29-cqa4-live-operator-trade.md; docs/capability-evidence/2026-05-30-cqa4-ap-gp-http-exchange.md; docs/resident-capabilities.md; docs/issue-register.md | pending | artifacts:data/benchmarks/capability-qa-2026-05-30/named_trade_soak_20260530092531.json,data/benchmarks/capability-qa-2026-05-30/named_trade_soak_20260530125718.json; test:src/controller/admin/named-trade-soak.test.ts; test:src/controller/city-integration/http-server.test.ts; test:src/controller/city-integration/ap-gp-exchange.test.ts; cmd:controller:trade-soak -- --unsafe-repeats=3; live:http POST /api/nullcity/residents/res%3Aqa-angler/ap-gp-exchanges; issue:QA-20260529-011 | named `res:qa-trader` operator/no-loop live soaks passed; dashboard/operator AP/GP route now live-proved with `res:qa-angler` burning 25 GP item `995` for 50 AP and surfacing in Library + `/economy/live` + BFF; next true human/player and ordinary resident-initiated exchange proof |
...
| S-TRADER-TRADE-1 | In Review | codex | 2026-05-31 | src/controller/{memory/runtime-state.ts,soul/{starter-souls/res-qa-trader.md,soul-loader.test.ts},spark/runescape-brain-planner.{ts,test.ts},thinking/{hybrid-agent-chat.ts,hybrid-agent-helpers.ts,hybrid-agent-thinking-module.{ts,test.ts}}}; docs/capability-evidence/2026-05-31-s-trader-trade-1.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:thinking+planner+soul focused 382/382; cmd:check:no-ui; cmd:build; issue:QA-20260531-050 | qa-trader no longer seeds explore patrol in ordinary life. It now seeds a trade-with-codex follow goal, uses trade-range follow, emits trade keepalive before idle stuck recovery, and can proactively request safe starter trades when adjacent/stocked. Post-restart CQA10/trade-soak proof is still pending. |
