...
| S3b | Blocked | codex | 2026-05-30 | src/controller/benchmarks/tasks/ap-gp-exchange-5m.ts; src/controller/benchmarks/autonomous-runtime.ts; docs/capability-evidence/2026-05-30-s3b-ap-gp-exchange-live-proof.md | pending | test:src/controller/benchmarks/tasks/ap-gp-exchange-5m.test.ts; test:src/controller/benchmarks/autonomous-runtime.test.ts; cmd:controller:bench ap-gp-exchange-5m autonomous | sandbox loopback `connect EPERM 127.0.0.1:43595`; rerun on loopback-permitted host for live artifact |
| S4a | Open | - | - | - | - | - | - |
| S4b | Open | - | - | - | - | - | - |
| S5a | Open | - | - | - | - | - | - |
| S5b | Open | - | - | - | - | - | - |
