...
| S1b | In Review | codex | 2026-05-29 | src/controller/benchmarks/tasks/{ap-decay-ask-5m.ts,ap-decay-ask-5m.test.ts,ap-topup-resume-5m.ts,ap-topup-resume-5m.test.ts}; src/controller/benchmarks/{autonomous-runtime.ts,autonomous-runtime.test.ts,cli.ts,cli.test.ts}; src/controller/nervous-system/nervous-system.ts; docs/capability-evidence/2026-05-29-s1b-ap-life-force-benchmark-attempt.md | pending | benchmark:bench_20260529175058_ap_decay_ask_5m; cmd:controller:bench -- --task ap-topup-resume-5m --mode autonomous --dry-run; test:ap-decay-ask-5m.test; test:ap-topup-resume-5m.test; test:autonomous-runtime.test; test:cli.test.ts | live `ap-topup-resume-5m` artifact still blocked by sandbox loopback `EPERM` (127.0.0.1:43595) |
