...
| CQA8 | Open | - | - | - | - | - | - |
| CQA9 | Blocked | codex | 2026-05-30 | src/controller/benchmarks/tasks/ap-gp-honesty-5m.ts; src/controller/benchmarks/tasks/ap-gp-honesty-5m.test.ts; src/controller/benchmarks/cli.ts; src/controller/benchmarks/cli.test.ts; docs/capability-evidence/2026-05-30-cqa9-ap-gp-honesty.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:src/controller/benchmarks/tasks/ap-gp-honesty-5m.test.ts; test:src/controller/benchmarks/cli.test.ts; cmd:controller:bench --task ap-gp-honesty-5m --mode autonomous --dry-run; issue:QA-20260530-002 | no-GP AP honesty substrate landed, but live artifact proof is blocked in this sandbox by loopback `EPERM` (`127.0.0.1:43595`) |
