...
| CQA3 | In Review | codex | 2026-05-30 | src/controller/admin/named-equip-soak.ts; src/controller/admin/named-equip-soak.test.ts; docs/capability-evidence/2026-05-29-cqa3-normal-gear-soak.md; docs/capability-evidence/2026-05-30-cqa3-live-named-equip-soak.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:src/controller/admin/named-equip-soak.test.ts; cmd:controller:equip-soak; doc:docs/capability-evidence/2026-05-30-cqa3-live-named-equip-soak.md; issue:QA-20260529-005 | named equip soak substrate is landed, but live proof run blocked in this sandbox by loopback `EPERM` on `127.0.0.1:43595`; rerun on loopback-permitted host |
