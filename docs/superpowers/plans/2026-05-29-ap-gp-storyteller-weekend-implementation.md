...
| CQA4 | In Review | codex | 2026-05-30 | src/controller/admin/named-trade-soak.ts; src/controller/admin/named-trade-soak.test.ts; docs/capability-evidence/2026-05-29-cqa4-live-operator-trade.md; docs/resident-capabilities.md; docs/issue-register.md | pending | artifact:data/benchmarks/capability-qa-2026-05-30/named_trade_soak_20260530092531.json; test:src/controller/admin/named-trade-soak.test.ts; cmd:controller:trade-soak; issue:QA-20260529-011 | named `res:qa-trader` operator-style live soak now passed with trusted trade completion, unsafe decline, and safe inventory delta outside benchmark harness; QA Marshal can review/close, next no-loop/human-operator proof |
| CQA5 | In Review | codex | 2026-05-30 | src/controller/benchmarks/tasks/combat-prayer-10m.ts; src/controller/benchmarks/tasks/combat-prayer-10m.test.ts; docs/capability-evidence/2026-05-29-cqa5-combat-survival.md; docs/resident-capabilities.md; docs/issue-register.md | d2e1607b | test:src/controller/benchmarks/tasks/combat-prayer-10m.test.ts; artifacts:data/benchmarks/cqa5-combat-rerun-2026-05-30-fix/bench_20260530122158_combat_prayer_10m.json,data/benchmarks/cqa5-combat-rerun-2026-05-30-fix/bench_20260530122229_combat_prayer_10m.json; cmd:controller:bench(combat-prayer-10m) | bounded safe-combat/prayer rerun passed 2/2 after verifier stopped early-aborting once combat-supplied bones appear; next: named-resident or model-triplet combat soak |
...
| CQA10 | In Review | codex | 2026-05-30 | docs/capability-evidence/2026-05-29-cqa10-normal-life-audit.md; docs/capability-evidence/2026-05-30-cqa10-normal-life-audit-refresh.md; docs/resident-capabilities.md; docs/issue-register.md | pending | doc:docs/capability-evidence/2026-05-30-cqa10-normal-life-audit-refresh.md; issue:QA-20260529-006 | one-hour refresh shows ordinary `equip=8` (improved from 0) with stable liveness; trade/combat still sparse (`trade_completed=0`,`trade_cancelled=0`,`attack=1`) so issue remains in review |
...
| CQA4 | Live operator trade | Named resident completes safe trade with operator/human and declines unsafe loop | initial named-resident action logs + inventory delta landed; next no-loop/human-operator soak |
