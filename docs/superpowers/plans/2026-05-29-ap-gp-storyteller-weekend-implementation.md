...
| S4a | In Review | codex | 2026-05-30 | src/controller/city-integration/{service.ts,service.test.ts,http-server.ts,http-server.test.ts}; docs/city-dashboard-integration.md | pending | test:service proposal facade; test:http-server proposal routes; cmd:check:no-ui/build/fin pending | dashboard JSON proposal queue/funding/admin-review routes ready; S4b birth materialization remains next |
| S4b | Open | - | - | - | - | - | - |
| S5a | Open | - | - | - | - | - | - |
| S5b | Open | - | - | - | - | - | - |
| S6a | Open | - | - | - | - | - | - |
