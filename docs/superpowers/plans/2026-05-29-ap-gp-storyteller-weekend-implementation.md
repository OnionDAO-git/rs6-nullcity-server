...
| S-AP-CYCLE-1 | In Review | codex | 2026-05-31 | src/controller/spark/self-initiated-ap-gp-exchange.{ts,test.ts}; src/controller/nervous-system/nervous-system.test.ts; src/controller/admin/{normal-life-audit.ts,normal-life-audit.test.ts}; docs/capability-evidence/2026-05-31-s-ap-cycle-1.md; docs/resident-capabilities.md; docs/issue-register.md; docs/superpowers/specs/2026-05-31-ap-decay-cycle-design.md | pending | test:self-initiated-ap-gp-exchange+nervous-system+normal-life-audit 65/65; cmd:controller:normal-life-audit --duration-ms=600000 --top=8; artifact:data/benchmarks/capability-qa-2026-05-31/s-ap-cycle-1/normal_life_audit_20260531T160104Z.json; issue:QA-20260531-054 | Option A implemented: no-floor residents now self-fund below 3000 AP and target 3500 AP, still capped at 250 GP/500 AP per exchange; audit now reports `exchangeThresholdAp`, `apUntilExchangeThreshold`, and `residentsApproachingExchangeThreshold`. Fresh 10m window stayed active (`23`, `964/964`, threshold 3000) but GP holders were still above threshold, so long-window recurrence remains next. |
