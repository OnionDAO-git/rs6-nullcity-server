...
| S-EXCHANGE-INIT-2 | Verified | codex | 2026-05-31 | src/controller/nervous-system/{nervous-system.ts,nervous-system.test.ts}; src/controller/resident-runtime.{ts,test.ts}; src/controller/controller-host.{ts,test.ts}; src/controller/index.ts; src/controller/benchmarks/autonomous-runtime.ts; docs/capability-evidence/2026-05-31-s-exchange-init-2-self-initiated-ap-gp-routing.md | pending | test:nervous+runtime+host+self-exchange benchmark/autonomous-runtime 147/147; cmd:controller:bench self-initiated-ap-gp-exchange-5m autonomous; artifact:bench_20260531054722_self_initiated_ap_gp_exchange_5m; issue:QA-20260529-011 | closes resident self-initiation routing seam: low-AP+GP nervous action now calls CityIntegrationService directly and live-proves AP up + coin-995 GP down |
...
| S7b | In Review | codex | 2026-05-30 | src/controller/storyteller/{model-client.ts,model-client.test.ts,run-cli.ts,run-cli.test.ts}; data/controller/storyteller/s5b-ncri-proof-20260530T0920/dispatch.json; docs/superpowers/plans/2026-05-29-ap-gp-storyteller-weekend-implementation.md; docs/superpowers/plans/2026-05-20-runescape-agent-roadmap.md; docs/agent-status.md | f9bdffd5+9f1e6316 | test:storyteller run/model client 17/17; test:storyteller suite 164/164; cmd:storyteller:run -- --latest nooped; cmd:live 1h digest fallback | storyteller:run can now narrate fixture, latest persisted digest, or named digest-id artifacts; no endpoint configured writes a reviewable grounded fallback dispatch instead of placeholder title/body copy, while configured profiles record model/profile/cost metadata |
| S8a | Open | - | - | - | - | - | - |
...
| S9b | In Review | cron-cloud | 2026-06-05 | src/controller/storyteller/public-frame.ts; src/controller/storyteller/public-frame.test.ts; src/controller/storyteller/verifier.test.ts | pending | test:src/controller/storyteller/public-frame.test.ts; test:src/controller/storyteller/verifier.test.ts; cmd:check:no-ui; cmd:fin 4248/4248 | - |
...
| S12a | Open | - | - | - | - | - | - |
| S12b | Open | - | - | - | - | - | - |
| S-ECON-VIEW-1 | In Review | codex | 2026-05-30 | src/controller/city-integration/{live-economy.ts,service.ts,http-server.ts,service.test.ts,http-server.test.ts}; docs/{city-dashboard-integration.md,superpowers/plans/2026-05-20-runescape-agent-roadmap.md} | pending | test:src/controller/city-integration/service.test.ts; test:src/controller/city-integration/http-server.test.ts; cmd:check:no-ui; cmd:build | `/api/nullcity/economy/{live,totals,events,residents}` shipped with redacted handles + `/live` cache header (`max-age=2`); S-ECON-VIEW-2 adds listings/heartbeat |
| S-ECON-VIEW-2 | In Review | codex | 2026-05-30 | src/controller/city-integration/{live-economy.ts,service.ts,http-server.ts,service.test.ts,http-server.test.ts}; docs/{city-dashboard-integration.md,issue-register.md,superpowers/plans/2026-05-20-runescape-agent-roadmap.md} | pending | test:src/controller/city-integration/service.test.ts; test:src/controller/city-integration/http-server.test.ts; cmd:check:no-ui; cmd:build | adds `/api/nullcity/economy/{listings,heartbeat}` plus dashboard contract docs; leaves optional SSE packet `S-ECON-VIEW-3` |
| S-ECON-VIEW-3 | In Review | codex | 2026-05-30 | src/controller/{index.ts,city-integration/{service.ts,service.test.ts,http-server.ts,http-server.test.ts}}; docs/{city-dashboard-integration.md,superpowers/plans/2026-05-29-ap-gp-storyteller-weekend-implementation.md,superpowers/plans/2026-05-20-runescape-agent-roadmap.md} | pending | test:src/controller/city-integration/service.test.ts; test:src/controller/city-integration/http-server.test.ts; cmd:check:no-ui; cmd:typecheck; cmd:build | adds feature-flagged `GET /api/nullcity/economy/stream` SSE snapshots (`event: economy_snapshot`, `data: {heartbeat,live}`) with interval clamp + `once=1` smoke mode and env flags `CONTROLLER_CITY_ECONOMY_STREAM{,_INTERVAL_MS}` |
| S-STORY-2 | In Review | codex | 2026-05-30 | src/controller/storyteller/{overseer.ts,overseer.test.ts}; src/controller/city-integration/{service.ts,service.test.ts,http-server.ts,http-server.test.ts}; docs/{city-dashboard-integration.md,superpowers/plans/2026-05-29-ap-gp-storyteller-weekend-implementation.md,superpowers/plans/2026-05-20-runescape-agent-roadmap.md} | pending | test:src/controller/storyteller/overseer.test.ts; test:src/controller/city-integration/service.test.ts; test:src/controller/city-integration/http-server.test.ts; cmd:check:no-ui; cmd:build; cmd:fin | adds Overseer publication cap + auto-publish controls for already-recorded dispatches, writes bounded canon/review dispatch surfaces, and exposes `GET /api/nullcity/storyteller/{canon,review}` queue contracts; paid spend preflight stays S-STORY-3 |
| S-NCRI-2 | In Review | codex | 2026-05-30 | src/controller/ncri/{ncri-registry.ts,ncri-registry.test.ts}; src/controller/city-integration/{service.ts,service.test.ts,http-server.ts,http-server.test.ts}; docs/{city-dashboard-integration.md,issue-register.md,superpowers/plans/2026-05-20-runescape-agent-roadmap.md} | pending | test:ncri-registry; test:src/controller/city-integration/service.test.ts; test:src/controller/city-integration/http-server.test.ts; cmd:check:no-ui; cmd:build | adds idempotent `POST /api/nullcity/ncri/:id/buy` with AP price-match guard, `saleStatus listed->sold`, sale evidence metadata, and rollback-safe transfer when event append fails |
| S-NCRI-3 | In Review | claude | 2026-05-31 | src/controller/city-integration/{service.ts,service.test.ts,http-server.ts,http-server.test.ts}; src/controller/ncri/ncri-registry.ts; docs/{issue-register.md,superpowers/plans/2026-05-29-ap-gp-storyteller-weekend-implementation.md} | pending | test:src/controller/city-integration/service.test.ts:864-1009; test:src/controller/city-integration/http-server.test.ts:1056-1095; cmd:check:no-ui; cmd:build | adds redeem-intent/redeem-complete routes, `GET /ncri/print-queue?status=` filter, `CityIntegrationService.{redeemNcriIntent,completeNcriRedemption,ncriPrintQueue}`, and `saleStatus awaiting_redemption/redeemed` transitions |
| S-NCRI-4 | In Review | claude | 2026-05-31 | src/controller/ncri/{seed-fixtures.ts,cli.ts,cli.test.ts}; package.json; docs/{issue-register.md,superpowers/plans/2026-05-29-ap-gp-storyteller-weekend-implementation.md} | pending | test:src/controller/ncri/cli.test.ts; cmd:ncri:seed; cmd:ncri:demo-sale; cmd:check:no-ui; cmd:build | seed fixtures (bronze-sword-first-light, tinderbox-of-the-flame, small-fishing-net-of-first-catch) + admin CLI commands `ncri:seed`/`ncri:demo-sale`; `demo-sale` creates Storyteller-ready NCRI economy evidence via `CityIntegrationService.buyNcri` |
| S-AUDIT-FIX-6 | In Review | codex | 2026-05-30 | src/controller/city-integration/{economy-event.ts,economy-event.test.ts}; docs/{issue-register.md,agent-status.md} | pending | test:src/controller/city-integration/economy-event.test.ts; cmd:check:no-ui | enforces per-line JSONL append guard (`<=4096` bytes) and adds concurrent-appender integrity regression to validate no torn-line parse loss under parallel writers |
...
| CQA4 | Verified | codex | 2026-05-31 | src/controller/admin/named-trade-soak.ts; src/controller/admin/named-trade-soak.test.ts; src/controller/city-integration/http-server.ts; src/controller/city-integration/http-server.test.ts; src/controller/city-integration/ap-gp-exchange.ts; src/controller/city-integration/ap-gp-exchange.test.ts; docs/capability-evidence/2026-05-29-cqa4-live-operator-trade.md; docs/capability-evidence/2026-05-30-cqa4-ap-gp-http-exchange.md; docs/capability-evidence/2026-05-31-cqa4-post-visible-trade-soak.md; docs/resident-capabilities.md; docs/issue-register.md | pending | artifacts:data/benchmarks/capability-qa-2026-05-30/named_trade_soak_20260530092531.json,data/benchmarks/capability-qa-2026-05-30/named_trade_soak_20260530125718.json,data/benchmarks/capability-qa-2026-05-31/cqa4-post-visible-trade-soak-1/named_trade_soak_20260531123430.json; test:src/controller/admin/named-trade-soak.test.ts; test:src/controller/city-integration/http-server.test.ts; test:src/controller/city-integration/ap-gp-exchange.test.ts; cmd:controller:trade-soak -- --unsafe-repeats=3; live:http POST /api/nullcity/residents/res%3Aqa-angler/ap-gp-exchanges; issue:QA-20260529-011 | named `res:qa-trader` operator/no-loop live soaks passed, including a fresh post-visible-speech current-stack soak (`tradeRequests=4`, trusted completion=1, unsafe cancellations=3, safe delta=-1, postUnsafeOffersOrAccepts=0); dashboard/operator AP/GP route now live-proved with `res:qa-angler` burning 25 GP item `995` for 50 AP and surfacing in Library + `/economy/live` + BFF; next true human/player and ordinary resident-initiated exchange proof |
| CQA5 | In Review | codex | 2026-05-30 | src/controller/benchmarks/tasks/combat-prayer-10m.ts; src/controller/benchmarks/tasks/combat-prayer-10m.test.ts; src/controller/admin/named-combat-soak.ts; src/controller/admin/named-combat-soak.test.ts; src/engine/world/actor/pathfinding.ts; src/engine/world/actor/pathfinding.test.ts; src/engine/world/actor/combat/combat-task.ts; src/engine/world/actor/combat/combat-task.test.ts; package.json; docs/capability-evidence/2026-05-29-cqa5-combat-survival.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:src/controller/benchmarks/tasks/combat-prayer-10m.test.ts; test:src/controller/admin/named-combat-soak.test.ts; test:src/engine/world/actor/pathfinding.test.ts; test:src/engine/world/actor/combat/combat-task.test.ts; artifacts:data/benchmarks/cqa5-combat-rerun-2026-05-30-fix/bench_20260530122158_combat_prayer_10m.json,data/benchmarks/cqa5-combat-rerun-2026-05-30-fix/bench_20260530122229_combat_prayer_10m.json,data/benchmarks/capability-qa-2026-05-30/named_combat_soak_20260530171822.json,data/benchmarks/capability-qa-2026-05-30/named_combat_soak_20260530173035.json; cmd:controller:bench(combat-prayer-10m); cmd:controller:combat-soak | bounded safe-combat/prayer rerun passed 2/2; hot-stack named `res:qa-survivor` soak passed starter combat, diagnostic rerun records low-health refusal after survival, and pathfinding/combat pursuit hardening fixes `_cost`/out-of-range combat noise |
...
| CQA10 | In Review | codex | 2026-05-30 | src/controller/admin/{normal-life-audit.ts,normal-life-audit.test.ts}; package.json; docs/capability-evidence/2026-05-29-cqa10-normal-life-audit.md; docs/capability-evidence/2026-05-30-cqa10-normal-life-audit-refresh.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:src/controller/admin/normal-life-audit.test.ts; cmd:controller:normal-life-audit -- --end 2026-05-30T12:59:25.832Z; cmd:controller:normal-life-audit; artifacts:data/benchmarks/capability-qa-2026-05-30/normal_life_audit_20260530T143812Z.json,data/benchmarks/capability-qa-2026-05-30/normal_life_audit_20260530T163610Z.json; issue:QA-20260529-006 | CQA10 now uses a reproducible CLI artifact and records freshness honestly: latest non-idle hour still shows trade intents (`trade_request=4`,`trade_decline=3`) with sparse combat (`attack=1`), while the latest wall-clock hour was fully idle (`0` residents/actions), so ordinary-life proof is stale until hot-stack rerun |
| CQA10-companion-metrics | In Review | codex | 2026-05-31 | src/controller/admin/{normal-life-audit.ts,normal-life-audit.test.ts}; docs/capability-evidence/2026-05-31-cqa10-companion-metrics.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:normal-life-audit red/green; cmd:controller:normal-life-audit post-QA004 window; artifact:data/benchmarks/capability-qa-2026-05-31/cqa10-companion-metrics/normal_life_audit_20260531T083614Z.json; issue:QA-20260529-006 | normal-life audit now emits non-truncated tracked action/cause/timeline count maps, `recurrenceSummary`, and `residentSlices`; rerun confirms low-health waits stayed 0 while AP/GP/trade closure remained 0 and stuck churn stayed high |
| CQA10-60m-companion-soak | In Review | codex | 2026-05-31 | docs/capability-evidence/2026-05-31-cqa10-60m-companion-soak.md; docs/resident-capabilities.md; docs/issue-register.md | pending | cmd:controller:normal-life-audit --duration-ms=3600000; artifact:data/benchmarks/capability-qa-2026-05-31/cqa10-60m-companion-soak/normal_life_audit_20260531T084257Z.json; issue:QA-20260529-006 | 60m companion metrics show active ordinary life and no low-health wait/death/logout regression, but no AP/GP or trade recurrence and high stuck churn; next=AP/GP GP-holdings root cause or stuck-churn reduction |
| CQA10-fresh-gp-scan-60m | In Review | codex | 2026-05-31 | docs/capability-evidence/2026-05-31-cqa10-fresh-gp-scan-60m.md; docs/resident-capabilities.md; docs/issue-register.md | pending | cmd:controller:normal-life-audit --duration-ms=3600000 --top=20; artifact:data/benchmarks/capability-qa-2026-05-31/cqa10-fresh-gp-scan-60m/normal_life_audit_20260531T110023Z.json; cmd:check:no-ui; issue:QA-20260529-006 | fresh 60m no-drain GP-scan window stayed active (`6694/6694`, `lowHealthWaits=0`, combat/eat/cook/xp present) but still had `apGpExchangeEvents=0`, `tradeRequests=0`, `economyEventsInWindow=0`; stuck churn improved vs prior 60m companion soak (`537/394` vs `1714/1592`) and remains open |
| CQA10-post-ap-cycle-recurrence-90m | In Review | codex | 2026-06-01 | docs/capability-evidence/2026-06-01-cqa10-post-ap-cycle-recurrence-90m.md; docs/resident-capabilities.md; docs/issue-register.md | pending | cmd:controller:normal-life-audit --duration-ms=5400000 --top=20; cmd:controller:smoke -- --observe-seconds 60 --allow-recent-visible; artifact:data/benchmarks/capability-qa-2026-06-01/cqa10-post-ap-cycle-recurrence-90m/normal_life_audit_20260601T001523Z.json; issue:QA-20260529-006/QA-20260531-054 | fresh 90m no-drain window closed the AP-cycle recurrence gap: `apGpExchangeEvents=8`, `organicSelfInitiatedApGpExchangeEvents=8`, `controlled=0`, `economyEventsInWindow=8`, success `4683/4683`. Trade closure still `0` and stuck churn remains high (`389/378`). |
| S-STUCK-ATTRIB-1 | In Review | codex | 2026-05-31 | src/controller/admin/{normal-life-audit.ts,normal-life-audit.test.ts}; docs/capability-evidence/2026-05-31-s-stuck-attrib-1.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:normal-life-audit red/green; cmd:controller:normal-life-audit --duration-ms=3600000 --top=20; artifact:data/benchmarks/capability-qa-2026-05-31/s-stuck-attrib-1/normal_life_audit_20260531T111938Z.json; issue:QA-20260529-006/QA-20260531-048 | normal-life audit now emits additive `stuckSummary` with aggregate unresolved stuck count and top residents by stuck churn; latest live window points next fixes at `res:qa-trader`, `res:agent`, `res:qa-social`, `res:pip`, and `res:qa-survivor` |
| S-TRADER-TRADE-1 | Verified | codex | 2026-05-31 | src/controller/{memory/runtime-state.ts,soul/{starter-souls/res-qa-trader.md,soul-loader.test.ts},spark/runescape-brain-planner.{ts,test.ts},thinking/{hybrid-agent-chat.ts,hybrid-agent-helpers.ts,hybrid-agent-thinking-module.{ts,test.ts}}}; docs/capability-evidence/2026-05-31-s-trader-trade-1.md; docs/capability-evidence/2026-05-31-cqa4-post-visible-trade-soak.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:thinking+planner+soul focused 382/382; cmd:check:no-ui; cmd:build; artifact:data/benchmarks/capability-qa-2026-05-31/cqa4-post-visible-trade-soak-1/named_trade_soak_20260531123430.json; issue:QA-20260531-050 | qa-trader no longer seeds explore patrol in ordinary life. It now seeds a trade-with-codex follow goal, uses trade-range follow, emits trade keepalive before idle stuck recovery, and can proactively request safe starter trades when adjacent/stocked. Post-visible-speech current-stack trade soak proves trusted closure and unsafe no-loop; ordinary-life recurrence remains open under CQA10/QA-20260529-006. |
| S-AGENT-VISIBLE-CADENCE-1 | Verified | codex | 2026-05-31 | src/controller/{memory/runtime-state.ts,resident-runtime.{ts,test.ts},admin/normal-life-audit.{ts,test.ts},thinking/{hybrid-agent-helpers.ts,hybrid-agent-thinking-module.{ts,test.ts}}}; docs/capability-evidence/2026-05-31-s-agent-visible-cadence-1.md; docs/resident-capabilities.md; docs/issue-register.md | pending | tests:thinking 283/283, resident-runtime 72/72, normal-life-audit 6/6; cmd:check:no-ui,typecheck,build,fin 3295/3295; live:post-restart-smoke READY, `res:agent` smoke OK, all-resident smoke WARN on `res:the-hush`/`res:qa-forager`; artifacts:data/benchmarks/capability-qa-2026-05-31/s-agent-visible-cadence-1/normal_life_audit_20260531T130330Z.json,data/benchmarks/capability-qa-2026-05-31/s-agent-visible-cadence-1/normal_life_audit_20260531T130535Z.json; issue:QA-20260531-051 | `res:agent` now emits and counts a deterministic `agent_keepalive` status line only when stuck/idle/no visible players, without interrupting active movement or anchor returns; audit tracks the cause. Latest 10m live rerun: 23 residents, 1183/1183 actions, `agent_keepalive=7`. Residual hero/Hush/Forager cadence remains open under CQA10. |
| S-TICK-PROGRESS-WEDGE-1 | Verified | codex | 2026-05-31 | src/controller/{resident-runtime.{ts,test.ts},admin/{live-smoke.{ts,test.ts},normal-life-audit.{ts,test.ts}}}; docs/capability-evidence/2026-05-31-s-tick-progress-wedge-1.md; docs/resident-capabilities.md; docs/issue-register.md | pending | tests:live-smoke+runtime+normal-life 110/110; cmd:check:no-ui,build,fin 3304/3304; live:targeted Hush smoke OK, full-cohort smoke 23/23 OK; artifact:data/benchmarks/capability-qa-2026-05-31/s-tick-progress-wedge-1/normal_life_audit_20260531T133451Z.json; issue:QA-20260531-052 | The all-resident +0t smoke scare was not a dead stack. Live-smoke now accepts sustained visible cadence during no-action budget ticks, and successful `faction_landmark_recovery` says count as visible progress. Post-restart Hush has `faction_landmark_recovery=30`, `say=32`, `stuck_detected=0`; next=trader/agent/social churn + economy recurrence. |
| S-ECON-RECURRENCE-3 | In Review | codex | 2026-05-31 | src/controller/admin/{normal-life-audit.ts,normal-life-audit.test.ts}; docs/capability-evidence/2026-05-31-s-econ-recurrence-3.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:normal-life-audit red/green 6/6; cmd:check:no-ui; cmd:build; cmd:fin 3304/3304; artifact:data/benchmarks/capability-qa-2026-05-31/s-econ-recurrence-3/normal_life_audit_20260531T134842Z.json; issue:QA-20260529-006/011 | normal-life audit now distinguishes dormant AP/GP from broken AP/GP (`aboveRunwayThresholdWithGpResidents`) and trade liveness from trade closure (`tradeKeepaliveActions`, `tradeStarterOffers`, `followListenHolds`). Fresh 10m window stayed active (`23` residents, `938/938`, `lowHealthWaits=0`) with `tradeKeepaliveActions=12`, `tradeStarterOffers=0`, no low-AP GP holders, and five GP holders above the 300 AP runway threshold; next=visible Codex target recurrence or true human/player operator pass. |
| S-AP-CYCLE-1 | Verified | codex | 2026-06-01 | src/controller/spark/self-initiated-ap-gp-exchange.{ts,test.ts}; src/controller/nervous-system/nervous-system.test.ts; src/controller/admin/{normal-life-audit.ts,normal-life-audit.test.ts}; docs/capability-evidence/2026-05-31-s-ap-cycle-1.md; docs/capability-evidence/2026-06-01-cqa10-post-ap-cycle-recurrence-90m.md; docs/resident-capabilities.md; docs/issue-register.md; docs/superpowers/specs/2026-05-31-ap-decay-cycle-design.md | pending | test:self-initiated-ap-gp-exchange+nervous-system+normal-life-audit 65/65; cmd:controller:normal-life-audit --duration-ms=5400000 --top=20; artifact:data/benchmarks/capability-qa-2026-06-01/cqa10-post-ap-cycle-recurrence-90m/normal_life_audit_20260601T001523Z.json; issue:QA-20260531-054 | Option A is now closed with live no-drain proof: 90m window shows repeated organic self-funding at threshold (`apGpExchangeEvents=8`, all organic, controlled/admin-drain `0`) while preserving action success `100%`. Remaining trade closure and stuck churn are tracked under QA-20260529-006. |
| S-TRADE-VISIBLE-TARGET-1 | In Review | codex | 2026-05-31 | src/controller/admin/{named-trade-soak.ts,named-trade-soak.test.ts}; src/engine/world/actor/resident/action/{agent-action.ts,agent-action.test.ts}; src/engine/net/{outbound-packet-handler.ts,outbound-packet-handler.test.ts}; docs/capability-evidence/2026-05-31-s-trade-visible-target-1.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:named-trade-soak+agent-action+outbound-packet-handler; cmd:check:no-ui; cmd:build; artifact:data/benchmarks/capability-qa-2026-05-31/s-trade-visible-target-1/named_trade_soak_20260531141406.json; issue:QA-20260529-006/011/QA-20260531-053 | proactive visible-target named soak passed score `1`: `res:qa-trader` emitted ordinary `trade_starter_offer` to visible `res:codex-tv3`, trusted peer reciprocated, trade completed, unsafe peer was cancelled, and no unsafe offer/accept followed. Packet also fixes fractional live resident `combatLevel` action schema and unencodable far reference packet crashes found during the proof. |
| S-MEM-1 | In Review | codex | 2026-05-31 | src/controller/memory/{facts-store.ts,facts-store.test.ts,resident-memory-service.ts,resident-memory-service.test.ts,memory-store.ts,memory-store.test.ts}; docs/capability-evidence/2026-05-31-s-mem-1.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:memory focused 13/13; cmd:check:no-ui,typecheck,build,fin3327/3327; issue:QA-20260530-006 | formal qmd facts substrate shipped: `FactsStore` owns `facts/<topic>.md`, `ResidentMemoryService` provides `rememberFact`/`readTopic`/`relevantTo`, existing `MemoryStore.retrieve` delegates facts search through the new store, and old `facts/world-events.md` remains compatible. Next=S-MEM-2 semantic memory + prompt block. |
| S-MEM-2A | In Review | codex | 2026-05-31 | src/controller/thinking/{hybrid-agent-prompts.ts,hybrid-agent-prompts.test.ts,hybrid-agent-helpers.ts,hybrid-agent-thinking-module.test.ts}; docs/capability-evidence/2026-05-31-s-mem-2a-prompt-memory.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:hybrid-agent-prompts+hybrid-agent-thinking-module 308/308; cmd:check:no-ui; cmd:build; issue:QA-20260530-006 | qmd/facts retrieval is now prompt-visible under a clear `Memory:` block for Brain, Body, and small-talk reply prompts. This intentionally does not add mem0, embeddings, hosted services, or paid model calls; full semantic S-MEM-2 remains blocked on maintainer backend choice. |
| S-MEM-3A | In Review | codex | 2026-05-31 | src/controller/{llm/completion-parser.{ts,test.ts},memory/memory-store.{ts,test.ts},thinking/{hybrid-agent-prompts.ts,hybrid-agent-prompts.test.ts,hybrid-agent-helpers.ts,hybrid-agent-thinking-module.test.ts}}; docs/capability-evidence/2026-05-31-s-mem-3a-brain-remember.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:completion-parser+memory-store+hybrid-prompts+hybrid-thinking 318/318; issue:QA-20260530-006 | Brain completions can now emit structured `rememberFact` qmd writes with safe topics, and runtime side effects persist them through `MemoryStore.rememberFact`; retrieval returns them as prompt-visible `Fact memory`. No mem0/paid calls. Next=live `memory-write-recall-10m` benchmark and MCP/operator lookup. |
| S-MEM-3B | Verified | codex | 2026-05-31 | src/controller/benchmarks/{cli.ts,cli.test.ts,autonomous-runtime.ts,autonomous-runtime.test.ts,benchmark-runner.ts,tasks/memory-write-recall-10m.ts,tasks/memory-write-recall-10m.test.ts}; src/controller/memory/{memory-router.ts,memory-router.test.ts}; src/controller/spark/runescape-brain-planner.{ts,test.ts}; src/controller/thinking/{hybrid-agent-chat.ts,hybrid-agent-helpers.ts,hybrid-agent-thinking-module.test.ts}; docs/capability-evidence/2026-05-31-s-mem-3b-memory-write-recall.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:focused 442/442; cmd:controller:bench --task memory-write-recall-10m --mode autonomous; benchmark:bench_20260531154414_memory_write_recall_10m score=1; cmd:check:no-ui; cmd:build; cmd:fin 3345/3345; issue:QA-20260530-006 | Live memory write+recall proof passes. The resident hears a durable fact, writes `facts/routes.md`, later receives a recall question, and answers `I remember west gate passphrase is ember-vellum.` Generic taught-fact recall now works for non-social `Fact memory (...)` entries; no paid calls. Next=ordinary named-resident 10+ minute NPC/quest/death recall and MCP/operator memory lookup. |
| CQA10-post-agent-cadence-followup | In Review | codex | 2026-05-31 | docs/capability-evidence/2026-05-31-cqa10-post-agent-cadence-followup.md; docs/resident-capabilities.md; docs/issue-register.md; docs/agent-status.md | pending | cmd:post-restart-smoke READY; cmd:controller:normal-life-audit --duration-ms=600000 --top=20; artifact:data/benchmarks/capability-qa-2026-05-31/cqa10-post-agent-cadence-followup/normal_life_audit_20260531T131056Z.json; issue:QA-20260529-006 | post-Agent cadence audit stayed healthy (`23` residents, `969/969`, `lowHealthWaits=0`, `agent_keepalive=6`, `res:agent` stuck `8/8/0`) but still had `apGpExchangeEvents=0`, `tradeRequests=0`, and `economyEventsInWindow=0`; next=ordinary trade/APGP recurrence or GP distribution route |
| S-EXCHANGE-RUNWAY-1 | In Review | codex | 2026-05-31 | src/controller/spark/self-initiated-ap-gp-exchange.{ts,test.ts}; src/controller/nervous-system/nervous-system.test.ts; docs/capability-evidence/2026-05-31-s-exchange-runway-1.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:self-initiated-ap-gp-exchange+nervous-system red/green 53/53; cmd:check:no-ui; cmd:build; issue:QA-20260529-006/011 | no-floor residents now self-fund below 300 AP instead of waiting below 20 AP; floor residents keep floor+20 trigger; next=restart controller and rerun 30-60m CQA10 recurrence |
| S-STUCK-CHURN-1 | In Review | codex | 2026-05-31 | src/controller/evidence/progress-tracker.{ts,test.ts}; src/controller/resident-runtime.test.ts; docs/capability-evidence/2026-05-31-s-stuck-churn-1.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:progress-tracker red/green; test:progress-tracker+resident-runtime 71/71; cmd:check:no-ui; cmd:build; issue:QA-20260529-006/QA-20260531-041 | default stuck threshold raised 20->45 ticks so ordinary 30-tick scouting pauses do not create false stuck/recovered churn; next=restart controller and compare CQA10 stuck churn |
| CQA10-post-restart-recurrence-early | In Review | codex | 2026-05-31 | docs/capability-evidence/2026-05-31-cqa10-post-restart-recurrence-early.md; docs/resident-capabilities.md; docs/issue-register.md | pending | cmd:controller:normal-life-audit --duration-ms=600000; artifact:data/benchmarks/capability-qa-2026-05-31/cqa10-post-restart-recurrence-early/normal_life_audit_20260531T090612Z.json; issue:QA-20260529-006/011 | early post-restart audit shows rebuilt runtime sees the AP/GP route and low-health waits remain fixed: 1283/1283 actions, APGP 1/1, lowHealthWaits 0, deaths/logouts 0, stuck churn 76/79. APGP came from controlled banker drain, so next=30-60m unconditioned recurrence plus GP-holdings scan |
| CQA10-unconditioned-economy-recurrence | In Review | codex | 2026-05-31 | src/controller/admin/{normal-life-audit.ts,normal-life-audit.test.ts}; docs/capability-evidence/2026-05-31-cqa10-unconditioned-economy-recurrence.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:normal-life-audit red/green; cmd:controller:normal-life-audit no-drain window; artifact:data/benchmarks/capability-qa-2026-05-31/cqa10-unconditioned-economy-recurrence/normal_life_audit_20260531T092301Z.json; cmd:check:no-ui; cmd:build; cmd:fin; issue:QA-20260529-006/011 | audit now splits controlled vs organic self-initiated AP/GP recurrence and latest-known GP runway; no-drain 22m window stayed healthy (2385/2385, lowHealthWaits 0, cook100/eat22/xp40) and caught organic APGP: res:qa-guide spent 101 GP item 995 for 202 AP; trade remains 0 |
| S-EXCHANGE-RECURRENCE-2 | In Review | codex | 2026-05-31 | docs/capability-evidence/2026-05-31-s-exchange-recurrence-2.md; docs/resident-capabilities.md; docs/issue-register.md; docs/superpowers/plans/2026-05-20-runescape-agent-roadmap.md | pending | cmd:controller:bench --task self-initiated-ap-gp-recurrence-10m --mode autonomous; artifact:data/benchmarks/capability-qa-2026-05-31/s-exchange-recurrence-2/bench_20260531081331_self_initiated_ap_gp_recurrence_10m.json; issue:QA-20260529-011 | autonomous recurrence verifier passed score `1` with `2/2` fully proven self-initiated AP/GP exchanges using coin item `995`; broad unconditioned multi-resident recurrence remains open |
| S-GP-FUEL-1 | Closed | codex | 2026-05-31 | data/config/npcs/goblins.json; src/controller/benchmarks/tasks/earn-gp-via-combat-5m.{ts,test.ts}; src/controller/spark/runescape-brain-planner.{ts,test.ts}; src/engine/config/config-handler.test.ts; docs/capability-evidence/2026-05-31-s-gp-fuel-1.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:earn-gp+planner+config 102/102; cmd:controller:bench --task earn-gp-via-combat-5m --mode autonomous; artifact:data/benchmarks/capability-qa-2026-05-31/s-gp-fuel-1/bench_20260531095843_earn_gp_via_combat_5m.json; issue:QA-20260530-035 | starter combat GP fuel now passes live: goblins drop `rs:coins` amount `3`, autonomous resident safely killed/looted and gained 3 GP item `995`; next=GP/hour/bank/sell/ordinary farming cadence |
| S-GP-HARVEST-1 | In Review | codex | 2026-05-31 | src/controller/{nervous-system/nervous-system.ts,nervous-system/nervous-system.test.ts,spark/runescape-brain-planner.ts,spark/runescape-brain-planner.test.ts,thinking/hybrid-agent-thinking-module.test.ts,admin/normal-life-audit.ts,admin/normal-life-audit.test.ts,benchmarks/{cli.ts,cli.test.ts,autonomous-runtime.ts,autonomous-runtime.test.ts,tasks/starter-gp-harvest-choice-5m.ts,tasks/starter-gp-harvest-choice-5m.test.ts}}; docs/capability-evidence/2026-05-31-s-gp-harvest-1.md; docs/resident-capabilities.md; docs/issue-register.md | pending | test:starter-gp-harvest+cli+autonomous-runtime 47/47; test:normal-life+planner+nervous+thinking 403/403; cmd:controller:bench --task starter-gp-harvest-choice-5m --mode autonomous; artifact:data/benchmarks/capability-qa-2026-05-31/s-gp-harvest-1/bench_20260531102153_starter_gp_harvest_choice_5m.json; issue:QA-20260531-047 | low-AP/no-GP floor residents with runnable standard/hybrid behavior now seed starter combat GP harvest instead of only asking humans; live proof shows harvest cue, safe goblin combat, 3 GP coin item `995`, no deaths/unsafe/stuck; follow-up guard keeps story/ambient residents on AP appeals instead of stale combat goals |
...
| D5 | In Review | codex | 2026-05-30 | `../rs6-nullcity-residents-dashboard` packages/server/src/{storyteller.ts,storyteller.test.ts,index.ts,config.ts,config.test.ts}; packages/web/src/{App.svelte,lib/{api,resident-story}.{ts,test.ts},app.css} | dashboard:7b1db56+401d657+be2734d+37d94ec+fbefd96 | test:bun test 262/262; cmd:bun run typecheck; cmd:bun run check; cmd:bun run build; api:/api/storyteller/digests 4 items and no raw `human:*`/email/patron ids; browser:/story/review%2Fs5b-ncri-proof-20260530T0920 shows review queue, NCRI dispatch, evidence refs, no console errors | Storyteller feed is live-verified against dry-run + review queue artifacts; paid-model dispatch remains opt-in with explicit cap |
...
| CQA4 | Live operator trade and AP/GP exchange | Named resident completes safe trade with operator/human, declines unsafe loop, and dashboard/operator can complete linked GP->AP exchange | named-resident action logs + inventory delta + repeated unsafe no-loop proof landed; AP/GP HTTP route proof landed with real GP item `995`; next human/player operator soak and ordinary resident-initiated exchange |
