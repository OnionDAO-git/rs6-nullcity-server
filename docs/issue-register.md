...
|---|---|---|---|---|---|---|---|---|---|
| QA-20260529-001 | P0 | Questing | Open | CQA1 | Questing / natural ingredient sourcing | issue:QA-20260529-001; `docs/resident-capabilities.md` says Cook's Assistant completion is proven with carried or visible ingredients, but natural egg/flour/milk sourcing from empty inventory is unproven. | unclaimed | 2026-05-29 | Add/run natural ingredient sourcing benchmark; fix route, item, dialogue, or inventory gaps found. |
| QA-20260529-002 | P0 | AP/GP economy | Open | S2b/CQA6 | GP earning | issue:QA-20260529-002; weekend loop requires GP as real RuneScape coins; capability doc does not yet prove resident GP earning/coin item `995` for AP-for-GP economy. | unclaimed | 2026-05-29 | Add GP inspect/earning proof and update capability row with artifact id. |
| QA-20260529-003 | P1 | Pathing/stuck recovery | Open | CQA2 | Movement / door-path recovery | issue:QA-20260529-003; door/path recovery is listed as unproven for indoor quest targets and required for richer quests. | unclaimed | 2026-05-29 | Add stuck-door/indoor-target benchmark; fix route clearing or door interaction as needed. |
