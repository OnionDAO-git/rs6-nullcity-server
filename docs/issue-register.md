...
| QA-20260529-008 | P0 | Resident intelligence | Blocked | S8c/CQA9/CQA11 | Goal planning / Library strategy | issue:QA-20260529-008; doc:docs/capability-evidence/2026-05-29-s8c-ap-gp-hierarchy-benchmark-attempt.md; code/tests: AP/GP hierarchy knowledge + prompt guardrails + `ap-gp-library-strategy-5m` benchmark substrate landed; live benchmark attempts at 2026-05-29 08:07 and 13:07 CDT both failed with `connect EPERM 127.0.0.1:43595`. | codex | 2026-05-29 | Run `ap-gp-library-strategy-5m` on loopback-permitted infra (outside this sandbox), then update capability matrix with the produced artifact id or downgrade the claim if behavior still fails. |
| QA-20260529-009 | P0 | AP life-force | Blocked | S1a/S1b | AP decay / top-up / fade-resume | issue:QA-20260529-009; benchmark:bench_20260529175058_ap_decay_ask_5m; doc:docs/capability-evidence/2026-05-29-s1b-ap-life-force-benchmark-attempt.md; test:src/controller/benchmarks/tasks/ap-topup-resume-5m.test.ts; cmd:npm run controller:bench -- --task ap-topup-resume-5m --mode autonomous --dry-run; follow-up substrate now includes fade->top-up->resume verifier + runtime top-up hook, but live artifact capture failed with loopback `EPERM` (`127.0.0.1:43595`). | codex | 2026-05-29 | Re-run `ap-topup-resume-5m` on loopback-permitted infra and record artifact id proving AP jump + resumed non-logout actions after fade. |
<<<<<<< HEAD
| QA-20260529-012 | P1 | Memory | Open | CQA7 | Memory route recall | issue:QA-20260529-012; doc:docs/capability-evidence/2026-05-29-cqa7-memory-route-recall.md; `CQA7` found strong taught-fact recall evidence (10 benchmark-run logs with 9 clear recall responses, plus 29 ordinary `nervous:patron-memory-acknowledge` actions across 3 residents), but delayed route reuse is still unproven and one malformed structured-dump reply occurred. | codex | 2026-05-29 | Add a delayed route-memory benchmark (teach route/fact, wait, then require route execution) and capture artifact/log proof; harden recall output formatting to avoid raw structured-dump speech. |
=======
| QA-20260529-011 | P1 | Trading | Open | CQA4 | Safe trading FSM | issue:QA-20260529-011; doc:docs/capability-evidence/2026-05-29-cqa4-live-operator-trade.md; ordinary controller logs currently show `0` trade actions (`rg '"kind":"trade_' data/controller/logs/res:*/actions/*.jsonl | wc -l`), while benchmark trading artifacts continue to pass. | codex | 2026-05-29 | Run a named-resident operator trade soak with inventory delta capture and ordinary action-log `trade_*` evidence, then fold results into capability matrix and CQA10 follow-up. |
>>>>>>> 6b97fa6f (docs(cqa4): record live-operator trade evidence gap)
