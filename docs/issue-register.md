...
| QA-20260530-001 | P0 | AP/GP economy | Blocked | S3b | AP-for-GP exchange live proof | issue:QA-20260530-001; doc:docs/capability-evidence/2026-05-30-s3b-ap-gp-exchange-live-proof.md; tests:src/controller/benchmarks/tasks/ap-gp-exchange-5m.test.ts,src/controller/benchmarks/autonomous-runtime.test.ts; cmd:controller:bench ap-gp-exchange-5m autonomous | codex | 2026-05-30 | S3b benchmark substrate is now implemented, but live artifact generation is blocked in this sandbox by loopback `connect EPERM 127.0.0.1:43595`. Re-run on loopback-permitted host and capture artifact id to close. |
