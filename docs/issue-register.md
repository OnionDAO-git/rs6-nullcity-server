...
| QA-20260529-005 | P1 | Equipment | In Review | CQA3-live | Equipment / normal gear soak | issue:QA-20260529-005; doc:docs/capability-evidence/2026-05-29-cqa3-normal-gear-soak.md; doc:docs/capability-evidence/2026-05-30-cqa3-live-named-equip-soak.md; cmd:controller:equip-soak; `CQA3-live` added a reproducible named-resident equip soak (forced unequip -> command-driven combat) but this sandbox cannot reach loopback gateway (`connect EPERM 127.0.0.1:43595`). | codex | 2026-05-29 | Run `npm run controller:equip-soak` on a loopback-permitted host, review `named_equip_soak_*.json` for resident `equip` then `attack`, and close if ordinary proof is present. |
