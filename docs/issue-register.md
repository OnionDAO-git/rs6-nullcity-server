...
| QA-20260530-002 | P1 | Resident intelligence | Blocked | CQA9 | AP/GP goal hierarchy + Library strategy | issue:QA-20260530-002; doc:docs/capability-evidence/2026-05-30-cqa9-ap-gp-honesty.md; test:src/controller/benchmarks/tasks/ap-gp-honesty-5m.test.ts; test:src/controller/benchmarks/cli.test.ts; cmd:controller:bench --task ap-gp-honesty-5m --mode autonomous --dry-run | codex | 2026-05-30 | CQA9 substrate now exists (`ap-gp-honesty-5m`) to verify no-GP low-AP honesty, but live autonomous proof is blocked in this sandbox (`connect EPERM 127.0.0.1:43595`). Re-run on loopback-permitted infra and record artifact id. |
| QA-20260529-012 | P1 | Memory | Blocked | CQA7 | Memory route recall | issue:QA-20260529-012; doc:docs/capability-evidence/2026-05-29-cqa7-memory-route-recall.md; doc:docs/capability-evidence/2026-05-30-cqa7-delayed-memory-route-recall.md; test:src/controller/benchmarks/tasks/memory-route-recall-5m.test.ts; cmd:controller:bench --task memory-route-recall-5m --mode autonomous --dry-run; delayed route-recall benchmark substrate is now landed, but live proof run is blocked in this sandbox (`connect EPERM 127.0.0.1:43595`). | codex | 2026-05-29 | Re-run `memory-route-recall-5m` on loopback-permitted infra and capture a real artifact id; then follow up on malformed structured-dump recall output hardening if failures persist. |
