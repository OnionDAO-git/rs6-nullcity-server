...
| QA-20260529-009 | P0 | AP life-force | Claimed | S1a/S1b | AP decay / top-up / fade-resume | issue:QA-20260529-009; CQA0 triage found AP life-force to be weekend-critical but under-proven in the capability matrix as a live behavior claim. | codex | 2026-05-29 | Landed S1a replay substrate (`attention` ledger helper + `city_attention_credit` before/after timeline fields); next run should execute S1b live low-AP fade/top-up/resume benchmark and update capability evidence. |
