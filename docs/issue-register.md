...
| QA-20260529-004 | P1 | Combat/survival | Open | CQA5/CQA11 | Combat survival | model-report:docs/model-intelligence-benchmark-results-2026-05-27.md; doc:docs/capability-evidence/2026-05-29-cqa11-model-intelligence-twins.md; refreshed triplet tally unchanged (`Qwen 0/6`, `Qwopus 3/6`, `Haiku 3/6`) with repeated unsafe-loop failures on Qwen hard runs. | codex | 2026-05-29 | Run `CQA5` combat-survival benchmark reruns with flee/eat/target-loop fixes, then re-score the same triplet profile set. |
...
| QA-20260529-009 | P0 | AP life-force | Open | S1a/S1b | AP decay / top-up / fade-resume | issue:QA-20260529-009; benchmark:bench_20260529175058_ap_decay_ask_5m; doc:docs/capability-evidence/2026-05-29-s1b-ap-life-force-benchmark-attempt.md; low-AP ask + attention-exhausted fade now live-proven (`attentionAfter` 10 -> 0). | codex | 2026-05-29 | Remaining gap: live patron AP top-up/resume proof after fade or near-fade. Add a follow-up benchmark/smoke that grants AP, resumes the resident, and records Library evidence. |
