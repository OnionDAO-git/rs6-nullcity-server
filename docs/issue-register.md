...
| QA-20260529-009 | P0 | AP life-force | Open | S1a/S1b | AP decay / top-up / fade-resume | issue:QA-20260529-009; CQA0 triage found AP life-force to be weekend-critical but under-proven in the capability matrix as a live behavior claim. | unclaimed | 2026-05-29 | Run S1a and S1b with focused tests plus a live AP decay/top-up artifact, then update capability evidence with exact run ids. |
