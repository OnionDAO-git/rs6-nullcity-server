...
| **HD-015** | High | Will the dashboard surface patron / Shards / letters / standing UI? | Partial — recent letters plus patron Shards/standing/balances are visible; relationship and readiness widgets still use this runbook |
...
- **HD-015**: dashboard surfaces recent patron letters plus Shards, standing, balances, tier counts, and next-tier gaps. Staff still reads relationship/readiness data via files/CLI.
