...
4. `skills/` for deeper per-skill workflow knowledge beyond starter. Currently: `skills/combat.md`, `skills/cooking.md`, `skills/crafting.md`, `skills/firemaking.md`, `skills/fishing.md`, `skills/fletching.md`, `skills/mining.md`, `skills/prayer.md`, `skills/smithing.md`, `skills/thieving.md`, `skills/woodcutting.md`. Add new skill files here as they're written. Each file should be agent-readable in the same prose-and-numbered-list style as `starter-workflows.md`.
