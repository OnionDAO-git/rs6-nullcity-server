...
The **Storyteller** is a smarter-model commentator that reads Null City logs, resident timelines, Attention events, quest progress, NCRI activity, and system state, then publishes a short public-canon dispatch every ~10 minutes.
...
- Treat Attention like life-force and civic currency.
...
> A new Soul is almost funded. It has a goal, a flaw, and just enough collective belief to become everyone's problem in about twelve more Shards.
...
| James / operators | What changed, what broke, who needs attention. | Operator notes with evidence links and warnings. |
...
- Soul born.
- Resident reaches low Attention.
- Resident fades/dies.
...
- Resident state snapshots: alive/faded/saved, position, goal, Attention balance.
- Quest progress and completion events.
- Attention ledger events.
...
- "Humans whose Attention changed the outcome."
- "New canon-worthy Library moments."
- "Quest/NCRI/Attention events since last dispatch."
...
6. Verifier checks:
   ...
   - no unsupported deaths, quest completions, NCRIs, or births.
...
- Read Attention ledger events when available.
...
6. Can Storyteller suggest quests or only narrate existing events?
7. Can Storyteller write permanent Library moments automatically?
8. How much profanity/snark is acceptable at the OnionDAO event?
9. Should Storyteller read humans as "patrons", "citizens", "visitors", or something faction-specific?
10. Should saved residents get a special Storyteller epilogue immediately on completion?
