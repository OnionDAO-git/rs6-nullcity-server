...
| One-hour multi-resident normal-life baseline (`CQA10`) | Yes (observability) | Yes, and exposes where ordinary life is still narrow | Latest refresh audit (`2026-05-30T11:09Z-12:09Z`) across 23 ordinary residents found 2457 actions at 99.06% submit success with dominant `move_to`/`say` loops, persistent stuck churn (`stuck_detected=734`, `stuck_recovered=557`), AP pressure still visible (13/23 residents dropped AP in-window, aggregate drop `12427`), and slightly improved higher-order behavior (`equip=8`, `attack=1`, `trade_completed=0`, `trade_cancelled=0`). Previous audit (`2026-05-29T01:41Z-02:41Z`) had `equip=0`/`trade_*=0`. See `docs/capability-evidence/2026-05-29-cqa10-normal-life-audit.md` and `docs/capability-evidence/2026-05-30-cqa10-normal-life-audit-refresh.md`. | Medium for proving liveness/recovery and showing some ordinary equip emergence; low-medium for economy/combat/social depth until ordinary trade/combat recurrence improves. |
