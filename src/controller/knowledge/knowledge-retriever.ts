...
export const ENGINE_KNOWLEDGE_ENTRIES: KnowledgeEntry[] = [
    ...
    },
    {
        ...
        keywords: ['magic', 'cast', 'spell', 'rune', 'runes', 'air', 'water', 'earth', 'fire', 'mind', 'chaos', 'death', 'wind strike', 'wave', 'teleport', 'alchemy', 'staff', 'spellbook'],
    ...
    },
    {
        ...
        keywords: ['ranged', 'range', 'bow', 'shortbow', 'longbow', 'arrow', 'arrows', 'bronze arrow', 'iron arrow', 'crossbow', 'bolt', 'shoot', 'fire arrow', 'safespot', 'leather', 'd hide', 'lowe'],
        ...
        successSignals: ['damage numbers on target', 'arrow count drops in ammo slot', 'ranged XP changes', 'dropped arrows appear on tile after combat'],
    ...
    },
    {
        ...
        keywords: ['cook', 'cooking', 'raw', 'shrimp', 'fish', 'meat', 'chicken', 'bread', 'cake', 'fire', 'range', 'burnt', 'food', 'heal'],
    ...
    },
    {
        ...
        keywords: ['smith', 'smithing', 'smelt', 'bar', 'bronze', 'iron', 'steel', 'mithril', 'adamant', 'rune', 'copper', 'tin', 'ore', 'furnace', 'anvil', 'hammer', 'forge'],
        requiredItems: ['ore (e.g., rs:copper_ore + rs:tin_ore for bronze)', 'hammer for forging at anvil (rs:hammer)', 'bar in inventory when at anvil'],
    ...
    },
    {
        ...
        successSignals: ['trade window opens for both players', 'offered items appear in counterparty pane', 'final accepted exchange transfers items + coins; trade XP not earned (no skill XP for trading)'],
