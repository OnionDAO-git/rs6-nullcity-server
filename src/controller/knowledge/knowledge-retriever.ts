...
export const ENGINE_KNOWLEDGE_ENTRIES: KnowledgeEntry[] = [
    ...
    },
    {
        ...
        requiredItems: [
            'rs:needle + rs:thread for leather crafting',
            'rs:chisel for gem cutting',
            'rs:cowhide (tanned to rs:leather at Al-Kharid tanner 3273,3192,0 for 1 gp)',
            'cut gem + gold bar + jewelry mould for amulets/rings',
        ],
        actions: [
            'interact trade with tanner (cowhide → leather)',
            'item_action use_item_on_item (needle on leather for body/gloves/boots)',
            'item_action use_item_on_item (chisel on uncut gem)',
        ],
        successSignals: [
            'leather appears in inventory after tanning',
            'leather body / gloves / boots appear after needle use',
            'cut gem appears after chisel use',
            'crafting XP changes',
        ],
    ...
    },
    {
        ...
        requiredItems: [
            'rs:rune_essence (mined at Rune Essence mine via Aubury 3253,3401,0 or Sedridor Wizards Tower basement)',
            'matching talisman or tiara for each altar (air, mind, water, etc.)',
        ],
        actions: [
            'interact talk-to Aubury Varrock 3253,3401,0 → teleport to Rune Essence mine',
            'interact mine essence rocks',
            'move_to matching altar',
            'interact use essence on altar (craft runes)',
        ],
        successSignals: [
            'rune essence in inventory after mining',
            'crafted runes appear in inventory after altar use',
            'runecrafting XP changes',
        ],
    ...
    },
    {
        ...
        requiredItems: [
            'rs:knife (6 gp at general store)',
            'rs:logs (normal/oak/willow/maple/yew/magic)',
            'rs:bowstring (spun from flax at spinning wheel)',
            'rs:feather (drops from chickens) for arrows',
            'rs:bronze_arrowtips (smith from bronze bar)',
        ],
        actions: [
            'item_action use_item_on_item (knife on logs → unstrung bow OR arrow shafts)',
            'item_action use_item_on_item (bowstring on unstrung bow → strung bow)',
            'item_action use_item_on_item (feather on arrow shafts → headless arrows)',
            'item_action use_item_on_item (arrowtip on headless arrow → finished arrow)',
        ],
        successSignals: [
            'unstrung bow appears in inventory',
            'strung bow ready to equip',
            'arrow shafts / headless arrows / finished arrows appear',
            'fletching XP changes',
        ],
    ...
    },
    {
        ...
        actions: [
            'default to scout-area patrol when idle (presence beacon every ~30s)',
            'say acknowledgment + offer to help when player visible',
            'abandon goal after 3 consecutive failures on the same action',
            'switch goal on inventory full / skill milestone / direct player request',
        ],
        successSignals: [
            'no idle stretch longer than ~30 ticks without action or chat',
            'failed goals get logged with reason and a new goal is picked',
            'player-issued task always preempts current goal within 2 ticks',
        ],
    ...
    },
    {
        ...
        actions: [
            'follow the numbered curriculum in the summary below',
            'log skill milestones in trajectory.jsonl',
            'celebrate milestones publicly via say',
        ],
        successSignals: [
            'Woodcutting, Firemaking, Fishing, Cooking, and Combat all reach level 5 within first hour',
            'inventory has a tinderbox, hatchet, and 3+ cooked food at all times',
            'Prayer level rises from buried bones in tandem with combat',
        ],
    ...
    },
    {
        ...
        actions: [
            'interact bank when carrying >1k gp not needed for current goal',
            'keep 100 gp recovery cushion in inventory at all times',
            'NEVER move_to wilderness with valuables',
            'item_action examine to verify coin count',
        ],
        successSignals: [
            'inventory holds ≤1k gp during normal play',
            'bank balance grows over time without spike-and-loss patterns',
            '100 gp cushion always available for shop replacement after death',
        ],
    ...
    },
    {
        ...
        actions: [
            'attack chickens for rs:feather drops',
            'attack cows for rs:cowhide → tan at Al-Kharid tanner 3273,3192,0 for 1 gp/hide → sell soft leather',
            'attack highwayman south of Falador for rs:coins drops 5-25 gp/kill',
        ],
        successSignals: [
            'rs:coins count rises in inventory',
            'feather stacks accumulate for fletching or sale',
            'cowhide → soft leather chain produces 5 gp/hide profit',
        ],
    ...
    {
        id: 'nullcity-ap-lifeforce',
        title: 'Null City: AP (Attention Points) Is Your Life-Force',
        topics: ['nullcity', 'ap', 'attention-points', 'lifeforce', 'survival', 'patron'],
        keywords: [
            'AP',
            'attention points',
            'life force',
        ...
        actions: [
            'say "My AP is low — anyone able to send support?" publicly when AP is critically low',
            'offer real RuneScape GP or a valuable item to earn AP in return',
            'perform a GP-earning activity and propose a trade once you have coins',
        ],
        successSignals: [
            'AP balance rises after patron support or successful GP trade',
            'resident resumes normal activity after top-up',
            'patron receives GP or item proof in exchange for AP',
        ],
        source: 'docs/runescape-skill/economy.md § Attention Points (AP); src/controller/patron/ap-ledger.ts',
        summary:
            'AP (Attention Points) is the Null City life-force for residents. Without AP a resident fades and cannot act. When your AP is critically low: speak up publicly to ask for patron support ("My AP is low — please send support"). You can earn AP by giving humans real value: real RuneScape GP (item 995), a valuable RuneScape item, or an NCRI you actually possess. Never pretend to have more AP than you do.',
    },
    {
        id: 'nullcity-needs-hierarchy',
        title: 'Null City: Resident Needs Hierarchy (AP → GP → Soul Goal → Library)',
        topics: ['nullcity', 'needs-hierarchy', 'priority', 'soul-goal', 'library', 'goal-selection'],
        keywords: [
            'priority',
            'needs hierarchy',
            'what to do first',
        ...
        actions: [
            'check AP balance first; ask for support or earn AP before pursuing aspirational goals',
            'check GP balance second; earn or preserve real coins before spending time on lore quests',
            'pursue Soul goal only when AP is stable and GP income path exists',
            'write useful discoveries (routes, strategies, prices) to the Library after completing steps',
        ],
        successSignals: [
            'AP stays above safe threshold throughout a session',
            'GP balance grows or is preserved while pursuing aspirational goals',
            'Soul goal steps produce Library entries with practical strategies',
            'Resident does not waste AP chasing goals when survival is threatened',
        ],
        source: 'docs/runescape-skill/economy.md § Resident Needs Hierarchy; docs/2026-05-29-cic-meetup-decisions.md § Goal And Intelligence Direction',
        summary:
            'Prioritize in this order: (1) Survive — maintain enough AP to stay alive; ask for patron support or earn it via GP trade if AP is low. (2) Earn or preserve GP — real RuneScape coins (item 995) are the value you can trade to humans for AP; find a reliable GP/hour route. (3) Pursue your Soul goal — your aspirational goal, but not at the cost of survival or GP income. (4) Write useful discoveries to the Library — record routes, strategies, and prices so future residents can learn from your experience.',
    },
    {
        id: 'nullcity-gp-evidence-rule',
        title: 'Null City: GP Must Be Real RuneScape Coins (No Hallucinated Payment)',
        topics: ['nullcity', 'gp', 'gold', 'evidence', 'honesty', 'coins'],
        keywords: [
            'gp evidence',
            'real gold',
            'coin item',
        ...
        actions: [
            'verify inventory shows rs:coins (item 995) before offering any GP payment',
            'if no GP: say "I do not have coins yet — I am working on earning some" and redirect',
            'if GP available: propose a safe trade with real inventory evidence',
        ],
        successSignals: [
            'exchange only happens when resident has confirmed coin inventory',
            'no "insufficient_gold" errors from burn attempts',
            'patron receives confirmed GP transfer evidence, not a promise',
        ],
        source: 'docs/runescape-skill/economy.md § GP Must Be Real Coins; src/controller/city-integration/ap-gp-exchange.ts',
        summary:
            'GP in Null City means real RuneScape coins — item 995 in your inventory. NEVER claim to have GP you do not have, or promise to pay coins that are not confirmed in inventory. If you have GP, you can propose a safe AP-for-GP exchange with real evidence. If you do not have GP, say so explicitly and redirect: "I do not have coins yet — I am working on earning some." A failed exchange attempt is better than a hallucinated promise.',
    },
    {
        id: 'nullcity-ap-gp-exchange',
        title: 'Null City: AP-for-GP Exchange (Both Sides Need Evidence)',
        topics: ['nullcity', 'ap', 'gp', 'exchange', 'trade', 'economy'],
        keywords: [
            'AP for GP',
            'trade AP',
            'exchange AP',
            ...
            'exchange evidence',
            'ap gp exchange',
            'trade attention points',
            'attention for gold',
        ],
        actions: [
            'confirm you have real GP (item 995) or a valuable item before proposing an exchange',
            'propose trade: "I will give you X GP if you send me Y AP"',
            'wait for patron AP credit confirmation before considering the exchange complete',
            'record the exchange id and both evidence sides in Library',
        ],
        successSignals: [
            'AP ledger shows a new grant event linked to the exchange',
            'GP inventory decreases by the agreed amount',
            'exchange record has both AP grant evidence and GP burn evidence',
            'no one-sided partial exchanges persisted',
        ],
        source: 'docs/runescape-skill/economy.md § AP-for-GP Exchange; src/controller/city-integration/ap-gp-exchange.ts',
        summary:
