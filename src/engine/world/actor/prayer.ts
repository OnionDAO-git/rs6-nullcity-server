...
export const PRAYERS: PrayerDefinition[] = [
    { id: 'thick_skin', name: 'Thick Skin', level: 1, buttonId: 8, configBit: 0, drain: 3, groups: ['defence'], soundId: s.thick_skin, modifiers: { defence: 0.05 } },
    { id: 'burst_of_strength', name: 'Burst of Strength', level: 4, buttonId: 9, configBit: 1, drain: 3, groups: ['strength'], soundId: s.burst_of_strength, modifiers: { strength: 0.05 } },
    { id: 'clarity_of_thought', name: 'Clarity of Thought', level: 7, buttonId: 10, configBit: 2, drain: 3, groups: ['attack'], soundId: s.clarity_of_thought, modifiers: { attack: 0.05 } },
    { id: 'sharp_eye', name: 'Sharp Eye', level: 8, buttonId: 11, configBit: 3, drain: 3, groups: ['ranged'], soundId: s.sharp_eye, modifiers: { ranged: 0.05 } },
    { id: 'mystic_will', name: 'Mystic Will', level: 9, buttonId: 12, configBit: 4, drain: 3, groups: ['magic'], soundId: s.mystic_will, modifiers: { magic: 0.05 } },
    { id: 'rock_skin', name: 'Rock Skin', level: 10, buttonId: 13, configBit: 5, drain: 6, groups: ['defence'], soundId: s.rock_skin, modifiers: { defence: 0.1 } },
    { id: 'superhuman_strength', name: 'Superhuman Strength', level: 13, buttonId: 14, configBit: 6, drain: 6, groups: ['strength'], soundId: s.superhuman_strength, modifiers: { strength: 0.1 } },
    { id: 'improved_reflexes', name: 'Improved Reflexes', level: 16, buttonId: 15, configBit: 7, drain: 6, groups: ['attack'], soundId: s.improved_reflexes, modifiers: { attack: 0.1 } },
    ...
    { id: 'hawk_eye', name: 'Hawk Eye', level: 26, buttonId: 19, configBit: 11, drain: 6, groups: ['ranged'], soundId: s.hawk_eye, modifiers: { ranged: 0.1 } },
    { id: 'mystic_lore', name: 'Mystic Lore', level: 27, buttonId: 20, configBit: 12, drain: 6, groups: ['magic'], soundId: s.mystic_lore, modifiers: { magic: 0.1 } },
    { id: 'steel_skin', name: 'Steel Skin', level: 28, buttonId: 21, configBit: 13, drain: 12, groups: ['defence'], soundId: s.steel_skin, modifiers: { defence: 0.15 } },
    { id: 'ultimate_strength', name: 'Ultimate Strength', level: 31, buttonId: 22, configBit: 14, drain: 12, groups: ['strength'], soundId: s.ultimate_strength, modifiers: { strength: 0.15 } },
    { id: 'incredible_reflexes', name: 'Incredible Reflexes', level: 34, buttonId: 23, configBit: 15, drain: 12, groups: ['attack'], soundId: s.incred_reflexes, modifiers: { attack: 0.15 } },
    { id: 'protect_from_magic', name: 'Protect from Magic', level: 37, buttonId: 24, configBit: 16, drain: 12, groups: ['overhead'], soundId: s.prot_from_mage, headIcon: 2 },
    { id: 'protect_from_missiles', name: 'Protect from Missiles', level: 40, buttonId: 25, configBit: 17, drain: 12, groups: ['overhead'], soundId: s.prot_from_ranged, headIcon: 1 },
    { id: 'protect_from_melee', name: 'Protect from Melee', level: 43, buttonId: 26, configBit: 18, drain: 12, groups: ['overhead'], soundId: s.prot_from_melee, headIcon: 0 },
    { id: 'eagle_eye', name: 'Eagle Eye', level: 44, buttonId: 27, configBit: 19, drain: 12, groups: ['ranged'], soundId: s.eagle_eye, modifiers: { ranged: 0.15 } },
    { id: 'mystic_might', name: 'Mystic Might', level: 45, buttonId: 28, configBit: 20, drain: 12, groups: ['magic'], soundId: s.mystic_might, modifiers: { magic: 0.15 } },
    { id: 'retribution', name: 'Retribution', level: 46, buttonId: 29, configBit: 21, drain: 3, groups: ['overhead', 'death'], soundId: s.retribution, headIcon: 3 },
    { id: 'redemption', name: 'Redemption', level: 49, buttonId: 30, configBit: 22, drain: 6, groups: ['overhead', 'death'], soundId: s.redemption, headIcon: 5 },
    { id: 'smite', name: 'Smite', level: 52, buttonId: 31, configBit: 23, drain: 18, groups: ['overhead', 'death'], soundId: s.smite, headIcon: 4 },
    { id: 'chivalry', name: 'Chivalry', level: 60, buttonId: 32, configBit: 24, drain: 24, groups: ['attack', 'strength', 'defence'], soundId: s.chivalry, modifiers: { attack: 0.15, strength: 0.18, defence: 0.2 } },
    { id: 'piety', name: 'Piety', level: 70, buttonId: 33, configBit: 25, drain: 24, groups: ['attack', 'strength', 'defence'], soundId: s.piety, modifiers: { attack: 0.2, strength: 0.23, defence: 0.25 } },
];
...
export class PrayerState {
    ...
    private syncHeadIcon(): void {
        const overhead = [...this.active]
            .map(id => PRAYERS_BY_ID.get(id))
            .find(definition => definition?.headIcon !== undefined);
