...
export const GEM_CUTTING_RECIPES: CraftingRecipe[] = [
    {
        toolIds: [craftingToolIds.chisel],
        ingredients: [{ itemId: 1623, amount: 1 }],
        output: { itemId: 1607, amount: 1 },
        level: 20,
        experience: 50,
    },
    {
        toolIds: [craftingToolIds.chisel],
        ingredients: [{ itemId: 1621, amount: 1 }],
        output: { itemId: 1605, amount: 1 },
        level: 27,
        experience: 67.5,
    },
    {
        toolIds: [craftingToolIds.chisel],
        ingredients: [{ itemId: 1619, amount: 1 }],
        output: { itemId: 1603, amount: 1 },
        level: 34,
        experience: 85,
    },
    {
        toolIds: [craftingToolIds.chisel],
        ingredients: [{ itemId: 1617, amount: 1 }],
        output: { itemId: 1601, amount: 1 },
        level: 43,
        experience: 107.5,
    },
];
