...
export const finishedPotionRecipes: FinishedPotionRecipe[] = [
    ...
    { unfinished: 'rs:marrentill_potion_unf', secondary: 'rs:unicorn_horn_dust', potion: 'rs:herblore_anti_poison_potion', level: 5, xp: 37.5 },
    { unfinished: 'rs:tarromin_potion_unf', secondary: 'rs:limpwurt_root', potion: 'rs:herblore_strength_potion', level: 12, xp: 50 },
    { unfinished: 'rs:harralander_potion_unf', secondary: 'rs:red_spiders_eggs', potion: 'rs:herblore_stat_restore_potion', level: 22, xp: 62.5 },
    ...
    { unfinished: 'rs:cadantine_potion_unf', secondary: 'rs:white_berries', potion: 'rs:herblore_super_defence_potion', level: 66, xp: 150 },
